...
wget -q  "https://iotdet.eu.loclx.io/file/mitigation_script/7/download/device" -O "/home/$username/allow_ports.py"
...
nohup python3 /home/$username/allow_ports.py $ports> /dev/null 2> /home/$username/allow_ports.log &
