    ...
    const columns = [
        ...
        },
        {
            ...
            options: {
                ...
                customBodyRenderLite: (dataIndex, rowIndex) => {
                    return (
                        <IconButton disabled={state.users[dataIndex].role === 0 || state.users[dataIndex].role === 1}
                                    onClick={() => setState({
                                        ...state,
                                        openDialogChangeRole: true,
                                        userSelectedIndex: dataIndex,
                                        newRole: state.users[dataIndex].role
                                    })}>
                        ...
                        <Grid item xs={12}>
                            <FormControl variant="filled" fullWidth>
                                ...
                                >
                                    ...
                                    <MenuItem value={1} disabled>Admin</MenuItem>
