...
const RootFilesDeployfilesMonitoringScripts = () => {
                        ...
                        <Grid container spacing={2}>
                            {
                                state.files.map((element, indexFile) => (
                                    <Grid item key={indexFile} xs={12} md={4} lg={3}>
                                        <CardDeployfileMonitoringScript  deployfile={element} can_validate={true} handleValidate={handleValidateFile} handleInvalidate={handleInvalidateFile}/>
                                    </Grid>
                                ))
                            }
                        </Grid>
...
export default RootFilesDeployfilesMonitoringScripts