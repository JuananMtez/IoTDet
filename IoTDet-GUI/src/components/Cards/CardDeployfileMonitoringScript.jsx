...
import DialogDeployfileMonitoringScriptDisabled from "../Dialog/DialogDeployfileMonitoringScriptDisabled.jsx";
import DoneSharpIcon from "@mui/icons-material/DoneSharp";
import CancelSharpIcon from "@mui/icons-material/CancelSharp";

const CardDeployfileMonitoringScript = ({deployfile, can_validate, handleValidate, handleInvalidate}) => {
    ...
    return (
        <>
            ...
            >
                <CardContent sx={{padding: '16px 16px 0px 16px'}}>
                    ...
                    <Typography variant="body3" sx={{color: 'wheat'}}>
                        Monitoring script deployed: {deployfile.monitoring_script.name}
                    </Typography>
            ...
            <DialogDeployfileMonitoringScriptDisabled open={openDialogInfo} deployfile={deployfile}
                                                      handleClose={() => setOpenDialogInfo(false)}/>
        </>
    )
}

export default CardDeployfileMonitoringScript