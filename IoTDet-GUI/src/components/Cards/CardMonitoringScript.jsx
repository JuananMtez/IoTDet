...
import DialogMonitoringScriptDisabled from "../Dialog/DialogMonitoringScriptDisabled.jsx";
import FullSizeDialog from "../Dialog/FullSizeDialog.jsx";
import CodeIcon from '@mui/icons-material/Code';
import {downloadMonitoringScript, getCodeFromMonitoringScript} from "../../services/FileRequests.js";
import LinkIcon from '@mui/icons-material/Link';
import DialogURL from "../Dialog/DialogURL.jsx";
import DoneSharpIcon from '@mui/icons-material/DoneSharp';
import CancelSharpIcon from '@mui/icons-material/CancelSharp';

const CardMonitoringScript = ({
    ...
    const handleClickDownloadMonitoringScript = () => {
        downloadMonitoringScript(monitoring_script_id)
            .then(response => {
    ...
    const handleOpenDialogCode = () => {
        ...
        getCodeFromMonitoringScript(monitoring_script_id)
            .then(response => {
                setState({
                    ...state,
                    openDialogCode: true,
        ...
        <>
            ...
            >
                ...
                <CardActions sx={{padding: '0px 8px 8px 8px'}} disableSpacing>
                    ...
                    <IconButton
                        aria-label="add to favorites" onClick={handleClickDownloadMonitoringScript} sx={{color:'white'}}>
                        <CloudDownloadIcon/>
                    </IconButton>

                    {
                        ...
                        }} disabled={is_validated} onClick={() => handleValidate(monitoring_script_id)}>
                            <DoneSharpIcon/>
                        </IconButton>
                    }
                    {
                        ...
                        onClick={() => handleInvalidate(monitoring_script_id)}>
                            <CancelSharpIcon/>
                        </IconButton>
                    }
            ...
            <DialogMonitoringScriptDisabled is_validated={is_validated} open={state.openDialogInfo} columns={columns}
            ...
            <DialogURL title="Link to download the monitoring script"
                       endpoint={`https://iotdet.eu.loclx.io/file/monitoring_script/${monitoring_script_id}/download/device`}
...
export default CardMonitoringScript